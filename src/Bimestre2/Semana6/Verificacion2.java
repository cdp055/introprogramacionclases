...
/**
 * Realice con métodos un programa que permita elegir un menú de opciones reiteradamente para
 * realizar las siguientes acciones: verificar si un número es primo o no, verificar si un número
 * ingresado es par, verificar si un número ingresado es impar.
 */
